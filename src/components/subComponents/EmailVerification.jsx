...
export default function EmailVerification() {
  return (
    <div className="h-screen md:h-[25rem] w-screen md:w-[43rem] p-2 sm:m-auto sm:mt-20 flex flex-col items-center justify-center md:justify-start text-center overflow-hidden">
